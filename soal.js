      ...
      const questionsPart1 = [
        {
          question: "The problems of squaring a Pan-European agenda regarding 25 countries union _______ a slow, complex, and divisive process.",
      ...
      {
          question: "When a muscle fiber worked intensely, it ____ potassium and dampened the fiber's ability to contract.",
          options: ["began to lose", "begins to lose", "has begun to lose", "begun to lose"],
          correctIndex: 0
        },
      {
          question: "The of girls in school and women in parliaments _____ and improved their overall access tocontraception in the past decade.",
          options: ["has risen", "rose", "rises", "had risen"],
          correctIndex: 1
        },
      {
          question: "Apple Computer has unveiled its new desktop computer design and _____ all disk drives and processors into a flat display less than two inches thick.",
          options: ["integrates", "integrated", "have integrates", "integrate"],
          correctIndex: 1
        },
      {
          question: "Astronomers on Tuesday News _____ the discovery of a new class of planets in which uninhabitable gas giants was previously discovered.",
          options: ["announce", "had announced", "announced", "have announced"],
          correctIndex: 2
        },
      {
          question: "For decades, the food industry ________ serving up sugary or fat-laden products promoted with ceaseless advertising.",
          options: ["has been known", "was known", "is known", "had been known"],
          correctIndex: 0
        },
      {
          question: "Japan's latitudinal spread, ranging from subtropical in the south to sub-arctic in the north, makes it have________ of flora and fauna.",
          options: ["the more widely diversity", "the most widely diversity", "more widely diversity than", "most widely diversity"],
          correctIndex: 1
        },
      {
          question: "Food is, after all, one of _________ Chinese culture which manage to spread all over the world.",
      ...
      {
          question: "For years, although it is controversial, meme has been considered pop art usingthe imagery of mass-media, mass-production and ____.",
          options: ["Mass-cultural", "Mass-culture", "Mass-cultured", "Mass-culturally"],
          correctIndex: 1
        },
      {
          question: "In the sea, a dolphin is considered themost intelligent mammal while the bluewhale is _____",
          options: ["the largest", "the most large", "larger", "more large"],
          correctIndex: 0
        },
      {
          question: "The use of labor-saving devices in homes,____ , and factories added to the amountof leisure time people had.",
          options: ["officially", "office", "to be offiially", "offices"],
          correctIndex: 3
        },
      {
          question: "_____ , a diamond will glow red, thenwhite due to reaction between thesurface of diamond and the air.",
          options: ["When first heated", "When first heating", "When heats", "When heats"],
          correctIndex: 0
        },
      {
          question: "Many renewable resources which emitless carbon dioxide and other greenhousegases are now found to ____",
      ...
      {
          question: "_____ the demands of aerospace, medicine, and agriculture, aengineers, are creating exotic new metallic substances.",
          options: ["Meet", "Being met are", "To meet", "They are meeting"],
          correctIndex: 2
        },
      {
          question: "_______ James A. Bland, “Carry Me Back to Old Virginny” was adopted is the state song of Virginia in 1940.",
      ...
      {
          question: "In the realm of psychological theory Margaret F. Washburn was a dualist _____ that motor phenomena have an essential role in psychology.",
          options: ["who she believed", "who believed", "believed", "who did she believe"],
          correctIndex: 1
        },
      {
          question: "The man came ____ if the car was still available.",
          options: ["See", "To see", "Seeing", "Seen "],
          correctIndex: 1
        },
      {
          question: "In the past, lions _______ common in many parts of the world.",
          options: ["Were", "Once", "When", "Only "],
          correctIndex: 0
        },
      {
          question: "At the 1984 Democratic National Convention in San Francisco, Geraldine Ferraro became the first woman _________ for the vice presidency.",
      ...
      {
          question: "Pepsin ____ an enzyme used in digestion.",
      ...
      {
          question: "____ large natural lakes are found in the state of South Carolina.",
          options: ["there are no", "not the", "it is not", "no "],
          correctIndex: 3
        },
      {
          question: "In a remarkable documentary, Wings of Hope, German director Werner Herzog recounts the true story of an eighteen year old girl, the sole survivor of a plane ……………….. in the Amazon jungle in 1971.",
          options: ["crashed", "crashing", "crash", "crashes"],
          correctIndex: 2
        },
      {
          question: "The consistency of protoplasm and that of glue ………………..",
          options: ["they are alike", "are similar to", "are similar", "the same"],
          correctIndex: 2
        },
      {
          question: "Although Margaret Mead had several assistants during her long investigations of Samoa, the bulk of research was done by ……………….. alone.",
          options: ["herself", "she", "her", "hers"],
          correctIndex: 2
        },
      {
          question: "……………….. who made Thanksgiving an official holiday in the United States.",
          options: ["Abraham Lincoln", "Was Abraham Lincoln", "Abraham Lincoln was", "It was Abraham Lincoln"],
          correctIndex: 3
        },
      {
          question: "If a ruby is heated, it ……………….. temporarily lose its color.",
          options: ["would", "will", "does", "has"],
          correctIndex: 1
        },
      {
          question: "Iguanas are different from most other lizards ……………….. they are not carnivores.",
          options: ["in spite of", "even", "so that", "in that"],
          correctIndex: 3
        },
      {
          question: "As a safety measure, the detonator for a nuclear device may be made of ……………….., each of which is controlled by a different employee.",
          options: ["two equipments", "two pieces of equipments", "two pieces of equipment", "two equipment pieces"],
          correctIndex: 2
        },
      {
          question: "The Breed Test, ……………….. method of counting bacteria in fresh milk, was developed by R.S. Breed in Geneva, New York, in 1925.",
          options: ["which, as a", "is a", "it is a", "a"],
          correctIndex: 3
        },
      {
          question: "First performed in 1976, ………………..",
      ...
      {
          question: "Not only ……………….. the most populous city in the United States in 1890, but it had also become the most congested.",
          options: ["was New York City", "that New York City was", "New York City was", "has New York City"],
          correctIndex: 0
        },
      {
          question: "The walls of arteries ……………….. into three layers.",
          options: ["they divide", "dividing", "to be divided", "are divided"],
          correctIndex: 3
        },
      {
          question: "If it ……………….. more humid in the desert of the Southwest, the hot temperatures would be unbearable.",
          options: ["be", "is", "was", "were"],
          correctIndex: 3
        },
      {
          question: "North Carolina is well known not only for the Great Smoky Mountains National Park ……………….. for the Cherokee settlements.",
          options: ["also", "and", "but also", "because of"],
          correctIndex: 2
        },
      {
          question: "To generate income, magazine publishers must decide whether to increase the subscription price or ………………..",
          options: ["to sell advertising", "if they should sell advertising", "selling advertising", "sold advertising"],
          correctIndex: 0
        },
      {
          question: "……………….. both men and women have often achieved their career ambitions by midlife, many people are afflicted by at least a temporary period of dissatisfaction and depression.",
          options: ["because", "so", "a", "who"],
          correctIndex: 0
        },
      {
          question: "When _________ the seminar?",
          options: ["the lecturer attended", "did the lecturer attend", "the lecturer will attend", "the lecturer’s attendance"],
          correctIndex: 1
        },
      {
          question: "Weeds that float to the surface __________ .",
          options: ["should remove", "be removed", "should be removed", "removed "],
          correctIndex: 2
        },
      {
          question: "Among the most revealing aspects of mining cities ________ their paucity of public open space.",
          options: ["was", "were", "it was", "so "],
          correctIndex: 0
        },
      {
          question: "The musical instrument from Japan _________ is six feet long.",
      ...
      {
          question: "Schengen visa is needed when_______European Countries",
          options: ["are travelling to", "to travel to", "travelling to", "we will be travelling to "],
          correctIndex: 2
        },
      {
          question: "Trees always_______nutritions, water, and sunlights to grow taller.",
          options: ["are needing", "needs", "they needs", "need "],
          correctIndex: 1
        },
      {
          question: "Across the country, _______have pointed fingers for decades than commercial fishers especially in dwindling stocks of sports fish.",
          options: ["more recreational fishers than", "the more recreational fishers", "the most recreational fishers", "more recreational fishers "],
          correctIndex: 3
        },
      {
          question: "Grizzlies are known for their______during the spawning run of salmon.",
          options: ["skill fishing", "skills fishing", "skillfully fishing", "skillful fishing "],
          correctIndex: 3
        },
      {
          question: "Iguanas are different from most other lizards________they are not carnivores.",
      ...
      {
          question: "After the funeral, the residents of the apartment building…….",
      ...
      {
          question: "Because the first pair of pants did not fit properly, he asked for…….",
          options: ["another pants", "other pants", "the others one", "another pair"],
          correctIndex: 3
        },
      {
          question: "The committee has met and…….",
      ...
      {
          question: "John’s score on the test is the highest in the class…….",
      ...
      {
          question: "Florida has not yet ratified the equal rights amendment, and…….",
      ...
      {
          question: "The chairman request that…….",
      ...
      {
          question: "California relies heavily on income from fruit crops, and…….",
          options: ["florida also.", "florida too.", "florida is as well", "so does florida"],
          correctIndex: 3
        },
      {
          question: "The professor said that…….",
      ...
      {
          question: "This year will be difficult for this organization because…….",
      ...
      {
          question: "The teacher have had some problem deciding…….",
      ...
      {
          question: "She wanted to serve some coffee to her guests; however…….",
      ...
      {
          question: "There has not been a great response to the sale…….",
          options: ["does there", "hasn’t there", "hasn’t it", "has there"],
          correctIndex: 3
        },
      {
          question: "A cloud is a dense mass of _____ water vapor or ice particles.",
          options: ["or", "whether", "both", "either"],
          correctIndex: 3
        },
      {
          question: "Centuries of erosion have exposed _____ rock surfaces in the Painted Desert of northern Arizona.",
          options: ["rainbow-colored", "colored like a rainbow", "in colors of the rainbow", "a rainbow’s coloring"],
          correctIndex: 0
        },
      {
          question: "Nellie Ross of Wyoming was the first woman _____ governor in the United States.",
          options: ["who elected", "to be elected", "was elected", "her election as"],
          correctIndex: 1
        },
      {
          question: "Dry farming is a type of agriculture used in areas _____ less than 20 inches of rainfall.",
          options: ["there are", "in which is", "where there is", "which has"],
          correctIndex: 2
        },
      {
          question: "Once known as the “Golden State” because of its gold mines, _____.",
      ...
      {
          question: "Amanda Way's career as a social reformer____ in 1851 when, at an antislavery meeting in Indiana, she called for a state woman's rights convention.",
      ...
      {
          question: "Protein digestion begins in the stomach ____ends in the small intestine.",
      ...
      {
          question: "Some colonies of bryozoans, small marine animals, form ___with trailing stems.",
      ...
      {
          question: "Natural selection is defined as the process ___the course of evolution by preserving those traits best adapted for an organism's survival.",
          options: ["to which directs", "of which directs it", "directs it", "that directs"],
          correctIndex: 3
        },
      {
          question: "____ 363 miles between the cities of Albany and Buffalo in New York State, the Eric Canal helped link the Atlantic Ocean with the Great Lakes.",
      ...
      {
          question: "Maufacturing is Canada's most important economic activity, ____17 percent of the workforce.",
          options: ["engages", "and to engage", "that it engage", "engaging"],
          correctIndex: 3
        },
      {
          question: "The gray scale, a progressive series of shades ranging from black to white, is used in computer graphics ---- detail to graphical images.",
          options: ["added", "to add", "are added", "and add"],
          correctIndex: 1
        },
      {
          question: "By ---- excluding competition from an industry, governments have often created public service monopolies.",
      ...
      {
          question: "Lenses ---- are used to correct imperfections in eyesight.",
      ...
      {
          question: "In eighteenth-century North America, printed engravings provided ---- of rococo style.",
      ...
      {
          question: "In the Arctic tundra, ice fog may form under clear skies in winter, ---- coastal fogs or low status clouds are common in summer.",
          options: ["because of", "whereas", "despite", "that"],
          correctIndex: 1
        },
      {
          question: "On attaining maximum size, ---- by drawing itself out and dividing into two daughter amoebas, each receiving identical nuclear materials.",
          options: ["the reproduction of the amoeba", "the amoeba, which reproduces", "reproducing the amoeba", "the amoeba reproduces"],
          correctIndex: 3
        },
      {
          question: "For the advertiser, one of the greatest appeals of radio is ---- an audience all day long.",
          options: ["that it has", "that to have", "to have it", "having it"],
          correctIndex: 0
        },
      {
          question: "Charles Schulz’s comic strip, “Peanuts,” features children who make --- about life.",
          options: ["funny, wise statements that", "which funny, wise statements", "statements are funny but wise", "funny but wise statements"],
          correctIndex: 3
        },
      {
          question: "One of the major rivers of the western United States, ---- flows for some 1,500 miles from Colorado to northwestern Mexico.",
          options: ["it is the Colorado River", "the Colorado River which", "and the Colorado River", "the Colorado River"],
          correctIndex: 3
        },
      {
          question: "In art, the tendency of gouache colors to lighten on drying makes ---- a wide range of pearly or pastel-like effects.",
          options: ["it is possible", "possible", "possible to be", "it possible the"],
          correctIndex: 1
        },
      {
          question: "Isabel Bishop was one of many American artists ---- by the government during the Depression years on various federal art projects.",
          options: ["employed", "whose employment", "to employ", "had been employed"],
          correctIndex: 0
        },
      {
          question: "Outbreaks of diseases in trees commonly occur ---- stressed because of drought or other environmental factors.",
          options: ["as forests that become", "in forests become", "that become forests", "when forests become"],
          correctIndex: 3
        },
      {
          question: "To break thick ice, an icebreaker boat moves fast enough to ride up on the ice, ---- under its weight.",
          options: ["so then breaks", "when breaks it", "which then breaks", "for which then breaks"],
          correctIndex: 2
        },
      {
          question: "Cholesterol is present in large quantities in the nervous system, where ---- compound of myelin.",
          options: ["it a", "a", "being a", "it is a"],
          correctIndex: 3
        },
      {
          question: "Captain Henry,_____________ crept slowly through the underbrush.",
      ...
      {
          question: "Tommy was one ____________________",
      ...
      {
          question: "_____________ he began to make friends more easily.",
      ...
      {
          question: "It is very difficult to stop the cultivation of marijuana because _____________",
      ...
      {
          question: "The fact that space exploration has increased dramatically in the past thirty ___________",
      ...
      {
          question: "Many of the current international problems we are now facing _______________",
      ...
      {
          question: "Mr.Roberts is a noted chemist_____________",
      ...
      {
          question: "Public television stations are different from commercial stations __________________",
      ...
      {
          question: "Manufacturers often sacrifice quality _______________________ -",
      ...
      {
          question: "Automobile production in the United States ____________",
      ...
      {
          question: "A major problem in the construction of new buildings _______________",
      ...
      {
          question: "John said that no other car could go ______________",
          options: ["so fast like his car", "as fast like his car", "as fast like the car of him", "as fast as his car"],
          correctIndex: 3
        },
      {
          question: "Her grades have improved, but only ________________",
          options: ["in a small amount", "very slightly", "minimum", "some"],
          correctIndex: 1
        },
      {
          question: "While attempting to reach his home before the storm,_______________",
      ...
      {
          question: "The changes in this city have occurred _________________",
          options: ["with swiftness", "rapidly", "fastly", "in rapid ways"],
          correctIndex: 1
        },
      {
          question: "The attorney told his client that _________________________",
      ...
      {
          question: "One of the professor’s greatest attributes is _______________",
          options: ["when he gives lectures", "how in the manner that he lectures", "the way to give lectures", "his ability to lecture"],
          correctIndex: 3
        },
      {
          question: "The bank sent a notice to its customers which contained _______________",
      ...
      {
          question: "______________ was the day before yesterday.",
      ...
      {
          question: "It was not until she had arrived home ______________ remembered her appointment with the doctor.",
          options: ["when she", "that she", "and she", "she"],
          correctIndex: 1
        },
      {
          question: "George would certainly have attended the proceedings ________________",
      ...
      {
          question: "_______________ received law degrees as today.",
          options: ["Never so many women have", "Never have so many women", "The women aren’t ever", "Women who have never"],
          correctIndex: 1
        },
      {
          question: "The students liked that professor’s course because _____________________",
      ...
      {
          question: "George ______________ he could improve his test scores, but he didn’t have enough time to study.",
          options: ["knew to", "knew how", "knew how that", "knew how to"],
          correctIndex: 1
        },
      {
          question: "_________________ he would have come to class.",
      ...
      {
          question: "Lee contributed fifty dollars, but he wishes he could contribute _______________",
          options: ["one other fifty dollars", "the same amount also", "another fifty", "more fifty dollars"],
          correctIndex: 2
        },
      {
          question: "The people at the party were worried about Janet because no one was aware _____________ she had gone.",
          options: ["where that", "of where", "of the place where", "the place"],
          correctIndex: 1
        },
      {
          question: "Fred’s yearly income since he changed professions has _________________",
          options: ["nearly tripled", "got almost three times bigger", "almost grown by three times", "just about gone up three times"],
          correctIndex: 0
        },
      {
          question: "Nancy hasn’t begun working on her Ph.D, ________________ working on her master’s.",
          options: ["still because she is yet", "yet as a result she is still", "yet because she is still", "still while she is already"],
          correctIndex: 2
        },
      {
          question: "The director of this organization must know _____________________",
      ...
      {
          question: "The Cyclist _______ he crossed the main street",
          options: ["Looked with caution after.", "Had looked cautiously before.", "Was looked cautions when.", "looks cautious when."],
          correctIndex: 1
        },
      {
          question: "Here_______ notebook and report that I promised you last week",
          options: ["Is the.", "Are the.", "Was the.", "Has been a."],
          correctIndex: 1
        },
      {
          question: "Neither Jane nor her brothers _______ a consent from for tomorrow's field Trip",
          options: ["Need.", "Needs.", "Is needing.", "Has need."],
          correctIndex: 0
        },
      {
          question: "Cuba is _______ sugar-growing areas in the world",
          options: ["One of the larger.", "One of largest.", "One of the largest.", "Largest."],
          correctIndex: 2
        },
      {
          question: "The skiers would rather _______ through the mountains than go by bus",
          options: ["To travel on train.", "Traveled by train.", "Travel by train.", "Travelling by the train."],
          correctIndex: 2
        },
      {
          question: "That magnificent _______ temple was constructed by the Chinese",
          options: ["eight-centuries-old.", "Eight-centuries’s-old.", "Old-eight centuries.", "eight-century-old."],
          correctIndex: 3
        },
      {
          question: "There were two small rooms in the beach house, _______ served as as a kitchen.",
          options: ["The smaller of which", "The Smallest of which.", "The Smaller of them.", "Smallest of that."],
          correctIndex: 0
        },
      {
          question: "Pioneer men and women endured terrible hardships, and _______",
          options: ["So do their children.", "Neither did the children.", "Also the Childs.", "Had he studied more."],
          correctIndex: 3
        },
      {
          question: "Mr. Duncan _______ his brother, who has a better position.",
      ...
      {
          question: "Mr. Duncan does not know _______ the lawn mower after they had finished using it.",
          options: ["When did they put.", "When they did put.", "Where they put.", "Where to put."],
          correctIndex: 2
        },
      {
          question: "The facilities of the older hospital _______",
      ...
      {
          question: "Our flight from Amsterdam to London was delayed _______.",
      ...
      {
          question: "The teacher suggested that her students _______ experiences with ESP.",
          options: ["Write a composition on their.", "To write composition about the.", "wrote some composition of his or her.", "Had written any composition for his."],
          correctIndex: 0
        },
      {
          question: "Of the two new teachers, one is experienced and _______",
          options: ["The others are not.", "Another is inexperienced.", "The other is not.", "Other lacks experience."],
          correctIndex: 2
        },
      {
          question: "I understand that the governor is considering a new proposal ______________",
      ...
      {
          question: "The doctor told his receptionist that he would return ________________",
      ...
      {
          question: "He has received several scholarships _____________________",
      ...
      {
          question: "Harvey will wash the clothes, ________________",
      ...
      {
          question: "_________________ that new information to anyone else but the sergeant.",
          options: ["They asked him not to give", "They asked him to don’t give", "They asked him no give", "They asked him to no give"],
          correctIndex: 0
        },
      {
          question: "_________________ he would have signed his name in the corner.",
      ...
      {
          question: "The doctor insisted that his patient ______________",
      ...
      {
          question: "The manager was angry because somebody ______________",
      ...
      {
          question: "Richard was asked to withdraw from graduate school because ____________",
      ...
      {
          question: "The committee members resented __________",
      ...
      {
          question: "_____________ did Arthur realize that there was danger.",
          options: ["Upon entering the store", "When he entered the store", "After he had entered the store", "Only after entering the store"],
          correctIndex: 3
        },
      {
          question: "The rabbit scurried away in fright __________________",
      ...
      {
          question: "When Henry arrived home after a hard day at work, ______________",
          options: ["his wife was sleeping", "his wife slept", "his wife has slept", "his wife has been sleeping"],
          correctIndex: 0
        },
      {
          question: "He gave ________________________",
      ...
      {
          question: "People all over the world are starving __________________________",
          options: ["greater in numbers", "in most numbers", "more numerously", "in greater numbers"],
          correctIndex: 3
        },
      {
          question: "It was not until she arrived in class__________ realized she had forgotten her book",
          options: ["when she", "and she", "that she", "She"],
          correctIndex: 2
        },
      {
          question: "John has not been able to recall where ____________________",
          options: ["does she live", "she lives", "did she live", "lived the girl"],
          correctIndex: 1
        },
      {
          question: "Ben would have studied medicine if he___________to a medical school.",
          options: ["could be able to enter", "had been admitted", "was admitted", "were admitted"],
          correctIndex: 1
        },
      {
          question: "He entered a university_________________",
          options: ["when he had sixteen years", "when sixteen years were his age", "at the age of sixteen", "at age sixteen years old"],
          correctIndex: 2
        },
      {
          question: "The jurors were told to _________________________",
          options: ["talk all they wanted", "make lots of expressions", "speak freely", "talk with their minds open"],
          correctIndex: 2
        },
      {
          question: "Those students do not like to read novels_________test books.",
          options: ["in any case", "forgetting about", "leaving out of the question", "much less"],
          correctIndex: 3
        },
      {
          question: "He____________looked forward to the new venture.",
          options: ["eagerly", "with great eagernes", "eagernessly", "in a state of increasing eagerness"],
          correctIndex: 0
        },
      {
          question: "The families were told to evacuate their houses immediately _____.",
      ...
      {
          question: "In the late 1970’s and early 1980’s, the United States developed the reusable space shuttle ________to space cheaper and easier.",
          options: ["to make access", "and making access", "which made accessible", "and made accessible."],
          correctIndex: 0
        },
      {
          question: "Genetically, the chimpanzee is more similar to humans _______.",
          options: ["are than any other animal", "than is any other animal", "any other animal is", "and any other animal is"],
          correctIndex: 1
        },
      {
          question: "_______more than 65,000 described species of protozoa, of which more than half are fossils.",
          options: ["Being that there are", "There being", "Are there", "There are"],
          correctIndex: 3
        },
      {
          question: "The Sherman Antitrust Act of 1890 ___ nearly unanimously through the United States Congress.",
      ...
      {
          question: "The average level of United States prices grew very little from 1953 until the mid-1960’s when ____________.",
          options: ["did inflation begin", "inflation began", "the beginning of inflation", "did the beginning of inflation"],
          correctIndex: 1
        },
      {
          question: "The basis premise behind all agricultural production is _____available the riches of the soil for human consumption.",
      ...
      {
          question: "________ of classical ballet in the United States began around 1830.",
      ...
      {
          question: "A situation in which an economic market is dominated by a ____ is known as a monopoly.",
          options: ["single of a product seller", "product single of a seller", "seller of a product single", "single seller of a product"],
          correctIndex: 3
        },
      {
          question: "____ freshwater species of fish build nests of sticks, stones, or scooped-out sand. .",
          options: ["As the many", "Of the many", "Many", "Many of them are"],
          correctIndex: 2
        },
      {
          question: "Newspaper publishers in the united states have estimated ___________reads a newspaper every day.",
      ...
      {
          question: "Many scientists believe _____ as a result of a collision between the newly formed Earth and a large asteroid.",
          options: ["that the Moon was formed", "in that the Moon was formed", "that the Moon formed was", "when the Moon was formed "],
          correctIndex: 0
        },
      {
          question: "The organ-pipe cactus is _____ in the United States.",
          options: ["Rare that", "It rare", "so that rare", "rare "],
          correctIndex: 3
        },
      {
          question: "Willa Cather,_____, gained recognition for her books concerning the American frontier.",
      ...
      {
          question: "The average wavelength of visible light is 2,000 times _____ the diameter of an atom.",
          options: ["much as", "as great", "greater than", "more than that "],
          correctIndex: 2
        },
      {
          question: "_____ ants live in nests, which may be located in the ground, under a rock, or built above ground and may be made of twigs, sand, or gravel.",
          options: ["Most", "The most of", "Most of", "Of the most "],
          correctIndex: 0
        },
      {
          question: "The banking systems of the world have many similarities, _____ they also differ, sometimes in quite material respects.",
          options: ["of which", "in spite of", "but", "how "],
          correctIndex: 2
        },
      {
          question: "Learning that takes place in infancy provides the____ for the eventual transformation of a child into an adult.",
          options: ["foundation is necessary", "necessary foundation is", "necessary in the foundation", "foundation necessary "],
          correctIndex: 3
        },
      {
          question: "In the late 1930’s and early 1940’s, Jacob Lawrence created many paintings _____ the lives of famous African American activists.",
          options: ["portayed", "portrayed them", "that they portrayed", "that portrayed "],
          correctIndex: 3
        },
      {
          question: "The Centennial Exposition, _____ in Philadelphia, Pennsylvania, in 1876, celebrated the one-hundredth anniversary of the Declaration of Independence.",
          options: ["was held", "to be held", "held", "by holding "],
          correctIndex: 2
        },
      {
          question: "In the dark abyss of the deep sea _____ is produced by luminescent fish.",
          options: ["because the only light", "the only light", "the only light that", "is the only light "],
          correctIndex: 1
        },
      {
          question: "The classic American novel Moby Dick____ an account of the conflict between human beings and their fate.",
          options: ["may be regarded as", "as may be regarded", "regarded as may be", "regarded may as be "],
          correctIndex: 0
        },
      {
          question: "In the metals industry, hydrogen is used to prevent metals from tarnishing while undergoing _____.",
      ...
      {
          question: "An unconsolidated aggregate of silt particles is also termed silt, __ a consolidated aggregate is called siltstone.",
          options: ["which", "why", "whereas", "whether"],
          correctIndex: 2
        },
      {
          question: "In 1864 the American Shakespearean actor Edwin Booth gained critical acclaim when he __ Hamlet at the Winter Garden Theater in New York City.",
          options: ["perform", "performed", "had been performing", "having performed"],
          correctIndex: 1
        },
      {
          question: "Most tangerine trees and their flowers and fruits resemble __ the orange, although tangerines are generally smaller.",
          options: ["of those", "which of those", "those of", "which are of"],
          correctIndex: 2
        },
      {
          question: "Ohio, the center of __ the Hopewen culture, has the greatest concentration of ancient burial mounds in the United States.",
      ...
      {
          question: "During the 1850, reform movements __ temperance and the abolition of slavery gained strength in the United States.",
          options: ["advocating", "they had advocated", "to advocating", "to advocate when"],
          correctIndex: 0
        },
      {
          question: "Many meteorites are thought to have originated from __ that once existed between the orbits of Mars and Jupiter.",
          options: ["where a planet or planets", "a planet or planets so", "which a planet or planets", "a planet or planets"],
          correctIndex: 3
        },
      {
          question: "The modem automobile is a __ composed of more than 14,000 parts.",
      ...
      {
          question: "The novelist John Dos Passos developed a style of fiction incorporating several documentary devices __ to his works.",
          options: ["lent realism", "that lending realism", "to lend realism", "of whose realism lent"],
          correctIndex: 2
        },
      {
          question: "In Earth’s infancy, its surface was warm enough for life __ the young Sun was fainter than it is today.",
          options: ["in spite of", "whether", "neither of which", "even though"],
          correctIndex: 3
        },
      {
          question: "The invention of the compound microscope (which allowed much higher magnification through multiple lenses) made __ the great strides in life sciences.",
          options: ["it possible", "possibly", "possible", "it was possible"],
          correctIndex: 2
        },
      {
          question: "Hares generally have longer ears and hind legs than rabbits and move by jumping __ running",
          options: ["rather to be", "rather than", "are rather", "as rather"],
          correctIndex: 1
        },
      {
          question: "Over the centuries, ____ that try to explain the origins of the university.",
          options: ["although many theories", "many theories", "have many theories been", "there have been many theories"],
          correctIndex: 3
        },
      {
          question: "The planet Venus is almost exactly the same size and mass _____ Earth, with a similar interior, including a nickel-iron core.",
          options: ["to", "as", "is", "than"],
          correctIndex: 1
        },
      {
          question: "George Washington Carver ____ international fame for revolutionizing agriculture research in the southern United States during the early twentieth century.",
      ...
      {
          question: "The tulip tree is native to the eastern United States, _____ the tallest and largest broadleaf tree.",
      ...
      {
          question: "Appointments to the United States Supreme Court and all lower federal courts ____ by the President with the advice and consent of the Senate.",
          options: ["making", "to make", "are made", "have made"],
          correctIndex: 2
        },
      {
          question: "The name “squirrel” is commonly used for those forms of the family Sciuridae that live in trees, _____ it is equally accurate for ground dwelling types.",
          options: ["whether", "that", "although", "in spite of"],
          correctIndex: 2
        },
      {
          question: "Green plants combine _____ with water and carbon dioxide to make food.",
      ...
      {
          question: "The Texas Legislature selected Vassar Miller _____ in 1982, and again in 1988.",
      ...
      {
          question: "The distinguishing feature of a fluid, in contrast to a solid, is the ease _____ .",
          options: ["that a deformed fluid", "to deform a fluid", "when a fluid that is deformed", "with which a fluid may be deformed"],
          correctIndex: 3
        },
      {
          question: "Oxygen and nutrients reach the body’s tissues ____ from the blood through the capillary wall.",
          options: ["pass", "by passing", "to be passing", "have passed"],
          correctIndex: 1
        },
      {
          question: "_____ important development of the Neolithic age was not in the manufacture of stone tools but in the production of food.",
          options: ["The most", "Most", "Most of", "Of the most"],
          correctIndex: 0
        },
      {
          question: "_____ Jane has an excellent resume, she hasn't found a job yet.",
          options: ["However", "Yet", "That", "Although"],
          correctIndex: 3
        },
      {
          question: "_____ several universities that have excellent engineering schools.",
          options: ["There are", "The", "There is a lot of", "Some of"],
          correctIndex: 0
        },
      {
          question: "Many Middle Eastern diplomats still feel that the United States is intent _____ the ultimate police in the region.",
          options: ["to being", "being", "be", "on being"],
          correctIndex: 3
        },
      {
          question: "Woodrow Wilson believed the United States' entry into World War I would put a _____ to the war in months.",
          options: ["to stop", "stop", "stopping", "will had stopped"],
          correctIndex: 1
        },
      {
          question: "_____ of New York's Erie Canal greatly enhanced trade in the upstate region.",
          options: ["The complete", "Completing", "A completing", "The completion"],
          correctIndex: 3
        },
      {
          question: "A leech, after _____ the skin, is best removed by the application of either salt or heat.",
          options: ["it attaches itself to", "attaching it", "its attaching to", "where it attaches to"],
          correctIndex: 0
        },
      {
          question: "_____ east of the Mississippi River.",
          options: ["Indigo was grown usually", "Usually grown was Indigo", "Indigo usually grown", "Indigo was usually grown"],
          correctIndex: 3
        },
      {
          question: "_____ wrote the operetta Babes in Toyland, drawn from the childhood characters of Mother Goose.",
          options: ["That was Victor Herbert who", "Victor Herbert who", "Since it was Victor Herbert", "It was Victor Herbert who"],
          correctIndex: 3
        },
      {
          question: "Some of the oldest and most widespread creation myths are _____ involving the all-giving 'Earth Mother.' ",
          options: ["those", "them", "they", "their"],
          correctIndex: 0
        },
      {
          question: "In _____ , disk technology has made record albums almost obsolete.",
          options: ["the decade from", "the decade since", "the past decade", "decade ago the"],
          correctIndex: 2
        },
      {
          question: "In the first few months of life, an infant learns how to lift its head, smile, and _____ .",
          options: ["parents to recognize", "recognize its parents", "recognizing its parents", "the recognizing of its parents"],
          correctIndex: 1
        },
      {
          question: "Juana Inez de la Cruz _____ Mexico's greatest female poet.",
          options: ["considered", "considered to be", "is considered to be", "is consideration"],
          correctIndex: 2
        },
      {
          question: "Because the metal mercury _____ in direct proportion to temperature, it was once used as the indicator in common thermometers.",
          options: ["is expanding", "expands", "is expanded", "expanded"],
          correctIndex: 1
        },
      {
          question: "_____ what is now San Salvador, Christopher Columbus believed that he had found Japan.",
          options: ["He reached", "When did he reach", "Having reached", "Whether he reached"],
          correctIndex: 2
        },
      {
          question: "The principal purpose of aviation medicine is _____ by people aboard an air¬craft in flight.",
      ...
      {
          question: "In simple animals, . . . . . . . . . . reflex movement or involuntary response to stimuli.",
          options: ["behavior mostly", "most is behavior", "most behavior is", "the most behavior"],
          correctIndex: 2
        },
      {
          question: "Although the whether in Martha's Vineyard isn't . . . . . . . . . . to have a year-around tourist season, it has become a favorite summer resort.",
          options: ["goodly enough", "good enough", "good as enough", "enough good"],
          correctIndex: 1
        },
      {
          question: "According to the wave theory, . . . . . . . . . . population of the Americas may have been the result of a of separate migrations.",
          options: ["the", "their", "that", "whose"],
          correctIndex: 0
        },
      {
          question: "It is presumed that governing the sharing of food influenced . . . . . . . . . . that the earliest cultures evolved.",
          options: ["that the way", "is the way", "the way", "which way"],
          correctIndex: 2
        },
      {
          question: "Calculus, . . . . . . . . . . elegant and economical symbolic system, can reduce complex problems to simple terms.",
          options: ["it is an", "that an", "an", "is an"],
          correctIndex: 2
        },
      {
          question: "Canada does not require that U. S. citizens obtain passports to enter the country, and . . . . . . . . . . .",
          options: ["Mexico does neither", "Mexico doesn't either", "neither Mexico does", "either does Mexico"],
          correctIndex: 1
        },
      {
          question: "The poet . . . . . . . . . . just beginning to be recognized as an important influence at the time of his death.",
          options: ["being Walt Whitman", "who was Walt Whitman", "Walt Whitman", "Walt Whitman was"],
          correctIndex: 3
        },
      {
          question: ". . . . . . . . . . . the formation of the sun, the planets, and other stars began with the condensation of an interstellar cloud.",
          options: ["It accepted that", "Accepted that", "It is accepted that", "That is accepted"],
          correctIndex: 2
        },
      {
          question: "As a general rule, the standard of living . . . . . . . . . . by the average output of each person in society.",
          options: ["is fixed", "fixed", "has fixed", "fixes"],
          correctIndex: 0
        },
      {
          question: "The Consumer Price Index lists . . . . . . . . . . .",
          options: ["how much costs every car", "how much does every car cost", "how much every car costs", "how much are every car cost"],
          correctIndex: 2
        },
      {
          question: "The Ford Theater where Lincoln was shot . . . . . . . . . . .",
          options: ["must restore", "must be restoring", "must have been restored", "must restored"],
          correctIndex: 2
        },
      {
          question: "Fast-food restaurants have become popular because many working people want . . . . . . . . . . .",
      ...
      {
          question: ". . . . . . . . . . , Carl Sandburg is also well-known for his multivolume biography of Lincoln.",
      ...
      {
          question: "The examiner made us . . . . . . . . . . our identification in order to be admitted to the test center.",
          options: ["showing", "show", "showed", "to show"],
          correctIndex: 1
        },
      {
          question: "The hard palate forms a partition ____ and nasal passages.",
          options: ["the mouth", "between the mouth", "is between the mouth", "it is between the mouth"],
          correctIndex: 1
        },
      {
          question: "Sam Spade in The Maltese Falcon and Rick Blaine in Casablanca ____ of Humphrey Bogart's more famous roles.",
          options: ["they are two", "two of them are", "two of them", "are two"],
          correctIndex: 3
        },
      {
          question: "____, the outermost layer of skin, is about as thick as a sheet of paper over most of the skin.",
          options: ["It is the epidermis", "In the epidermis", "The epidermis", "The epidermis is"],
          correctIndex: 2
        },
      {
          question: "During the Precambrian period, the Earth's crust formed, and life ____ in the seas.",
          options: ["first appeared", "first to appear", "is first appearing", "appearing"],
          correctIndex: 0
        },
      {
          question: "When fluid accumulates against the eardrum, a second more insidious type of ____",
          options: ["otitis media may develop", "developing otitis media", "the development of otitis media", "to develop otitis media"],
          correctIndex: 0
        },
      {
          question: "Before the Statue of Liberty arrived in the United States, newspapers invited the public to help determine where ____ placed after its arrival.",
          options: ["should the statue be", "the statue being", "it should be the statue", "the statue should be"],
          correctIndex: 3
        },
      {
          question: "A stock ____ at an inflated price is called a watered stock.",
          options: ["issued", "is issued", "it is issued", "which issued"],
          correctIndex: 0
        },
      {
          question: "Acidic lava flows readily and tends to cover much larger areas, while basic lava ____.",
          options: ["viscous", "is more viscous", "more viscous", "it is more vicious"],
          correctIndex: 1
        },
      {
          question: "Seismic reflections profiling has ____ the ocean floor is underlain by a thin layer of nearly transparent sediments.",
          options: ["reveal that", "revealed that", "the revelation of", "revealed about"],
          correctIndex: 1
        },
      {
          question: "____ and terrifying, coral snakes can grow to 4 feet (1. 2 meters) in length.",
          options: ["They are extremely poisonous", "The poison is extreme", "Extremely Poisonous", "An extreme amount of poison"],
          correctIndex: 2
        },
      {
          question: "The leaves of the white mulberry provide food for silkworms, ____ silk fabrics are woven.",
          options: ["whose cocoons", "from cocoons", "whose cocoons are from", "from whose cocoons"],
          correctIndex: 3
        },
      {
          question: "As ____ in Greek and Roman mythology, harpies were frightful monsters that were half woman and half bird.",
          options: ["described", "to describe", "description", "describing"],
          correctIndex: 0
        },
      {
          question: "Not only ____ generate energy, but it also produces fuel for other fission reactors.",
      ...
      {
          question: "D. W. Griffith pioneered many of the stylistic features and filmmaking techniques ____ as the Hollywood standard.",
          options: ["that established", "that became established", "what established", "what became established"],
          correctIndex: 1
        },
      {
          question: "_____ be needed, the water basin would need to be dammed.",
          options: ["Hydroelectric power should", "When hydroelectric power", "Hydroelectric power", "Should hydroelectric power"],
          correctIndex: 3
        },
      {
          question: "_______ range in color from pale yellow to bright orange.",
          options: ["Canaries which", "Canaries", "That canaries", "Canaries that are"],
          correctIndex: 1
        },
      {
          question: "_______ of precious gems is determined by their hardness, color, and brilliance.",
          options: ["The valuable", "It is the value", "It is valuable", "The value"],
          correctIndex: 3
        },
      {
          question: "_______ a tornado spins in a counterclockwise direction in the northern hemisphere, it spins in the opposite direction in the southern hemisphere.",
          options: ["However", "Because of", "Although", "That"],
          correctIndex: 2
        },
      {
          question: "The Caldecott Medal, _______ for the best children's picture book, is awarded each January.",
          options: ["a prize", "which prize", "is a prize which", "is a prize"],
          correctIndex: 0
        },
      {
          question: "The horn of the rhinoceros consists of a cone of tight bundles of keratin _______ from the epidermis.",
          options: ["grow", "grows", "growing", "they grow"],
          correctIndex: 2
        },
      {
          question: "Most species of heliotropes are weeds, _______ of them are cultivated.",
          options: ["some", "but some", "for some species", "some species"],
          correctIndex: 1
        },
      {
          question: "Thunder occurs as _______ through air, causing the heated air to expand and collide with layers of cooler air.",
          options: ["an electrical charge", "passes an electrical charge", "the passing of an electrical charge", "an electrical charge passes"],
          correctIndex: 3
        },
      {
          question: "Researchers have long debated _______ Saturn's moon Titan contains hydrocarbon oceans and lakes.",
          options: ["over it", "whether it", "whether", "whether over"],
          correctIndex: 2
        },
      {
          question: "Nimbostratus clouds are thick, dark grey clouds _______ forebode rain.",
          options: ["what", "which", "what they", "which they"],
          correctIndex: 1
        },
      {
          question: "_______ in several early civilizations, a cubit was based on the length of the forearm from the tip of the middle finger to the elbow.",
          options: ["It was used as a measurement", "A measurement was used", "The use of a measurement", "Used as a measurement"],
          correctIndex: 3
        },
      {
          question: "Only when air and water seep through its outer coat _______",
          options: ["does a seed germinate", "to the germination of a seed", "a seed germinates", "for a seed to germinate"],
          correctIndex: 0
        },
      {
          question: "_______ seasonal rainfall, especially in regions near the tropics, is winds that blow in an opposite direction in winter than in summer.",
          options: ["Causing", "That cause", "To cause", "What causes"],
          correctIndex: 3
        },
      {
          question: "The extinct Martian volcano Olympus Mons is approximately three times as _______ Mount Everest.",
          options: ["high", "high as is", "higher than", "the highest of"],
          correctIndex: 1
        },
      {
          question: "The flight instructor, _______ at the air base, said that orders not to fight had been given.",
          options: ["when interviewed", "when he interviewed", "when his interview", "when interviewing"],
          correctIndex: 0
        },
      {
          question: "In the northern and central parts of the state of Idaho _______ and churning rivers.",
          options: ["majestic mountains are found", "found majestic mountains", "are found majestic mountains", "finding majestic mountains"],
          correctIndex: 2
        },
      {
          question: "The musical comedy Oklahoma did much to expand the potential of the musical stage, and it encouraged others to attempt. . . . . .",
          options: ["original themes", "to original themes", "that were original themes", "how original themes"],
          correctIndex: 0
        },
      {
          question: "Despite its fishlike form, the whale is. . . . . . and will drown if submerged too long.",
          options: ["an animal breathes air that", "an animal that breathes air", "an animal breathes air", "that an animal breathes air"],
          correctIndex: 1
        },
      {
          question: "The saguaro, found in desert regions in the southwestern United States ,. . . . . . cactus in the world.",
          options: ["is the largest", "the largest", "that is the largest", "the largest that is a"],
          correctIndex: 0
        },
      {
          question: "It is said that United Stales literature ____________ individuality and identity in the twentieth century, after long imitation of European models.",
          options: ["was achieved", "achieved", "to achieve", "achieving"],
          correctIndex: 1
        },
      {
          question: "Lucy Stone, ____________ first feminists in the United States, helped organize the American Woman Suffrage Association in 1869.",
          options: ["the one", "who was the", "another", "one of the"],
          correctIndex: 3
        },
      {
          question: "_______, including climate, mineral content, and the permanency of surface water, wetlands may be mossy, grassy, scrubby, or wooded.",
          options: ["Depending on many factors", "Many factors depending on", "Factors depending on many", "On many factors depending"],
          correctIndex: 0
        },
      {
          question: "Duke Ellington's orchestra, _______ his own often complex compositions, made many innovations in jazz.",
          options: ["he played", "playing", "that it played", "was playing"],
          correctIndex: 1
        },
      {
          question: "The term 'ice age' refers to any of several periods of time when glaciers covered considerably more of Earth's surface _______.",
          options: ["as is today", "than today is", "than they do today", "that today"],
          correctIndex: 2
        },
      {
          question: "From colonial times, United States property owners agreed to tax themselves on the theory. . . . . . directly from services that the government could provide.",
      ...
      {
          question: "Helium is not flammable and, next to hydrogen, is. . . . . .",
          options: ["known the lightest gas", "lightest the known gas", "the lightest gas known", "the known gas lightest"],
          correctIndex: 2
        },
      {
          question: "Wild eagles that survive to adulthood are believed. . . . . . from 20 to 30 years.",
          options: ["live", "to live", "they live", "their living"],
          correctIndex: 1
        },
      {
          question: "Portland, . . . . . . , is located primarily on two hilly peninsulas overlooking Casco Bay and its many island.",
          options: ["which Maine's largest city", "Maine's largest city where", "is Maine's largest city", "Maine's largest city"],
          correctIndex: 3
        },
      {
          question: ". . . . . . widely used in the chemical industry, sodium carbonate is principally consumed by the glass industry.",
          options: ["Despite", "Whether", "Though", "Except for"],
          correctIndex: 2
        },
      {
          question: "Cells, first identified by the early microscopists, began to be considered . . . . . . in the nineteenth century.",
      ...
      {
          question: "Like Jupiter, Saturn is a large, gaseous planet composed. . . . . . of hydrogen and helium.",
          options: ["it is mostly", "mostly", "almost", "both are almost"],
          correctIndex: 1
        },
      {
          question: "The ancestors of the horse lived . . . . . and were about half a meter tall.",
          options: ["years ago 60 million", "60 million years ago", "ago 60 million years", "million years ago 60"],
          correctIndex: 1
        },
      {
          question: "The museum on Ellis Island, a former immigration station, contains documents and artifacts. . . . . . to four centuries of United States immigration.",
          options: ["related them", "related", "related that", "be related"],
          correctIndex: 1
        },
      {
          question: "_________, particularly the oxides of sulfur, greatly increases the rate at which rust forms.",
      ...
      {
          question: "The Sun, the Moon, and Earth have magnetic fields, and _________ evidence that the stellar that extend through vast regions galaxies have fields of space.",
          options: ["which is", "is", "because", "There is"],
          correctIndex: 3
        },
      {
          question: "The “confederation school” poets of nineteenth-century Canada were primarily nature poets, _________ a wealth of eulogies to Canadian rural life.",
      ...
      {
          question: "Just over two-thirds of Earth’s surface is covered by water, . . . . . . more than 98 percent of this water is contained in the oceans.",
          options: ["with", "which", "and", "resulting"],
          correctIndex: 2
        },
      {
          question: "Pleasing to look at and touch, beads come in shapes, colors, and materials . . . . . . . to handle and to sort them.",
          options: ["that almost compel one", "one compels", "that compel almost", "one is almost compelled"],
          correctIndex: 0
        },
      {
          question: "In 1978 the united States National Air and Space Administration selected Sally Ride. . . . . . . the first woman astronaut.",
          options: ["who being", "to be", "and being", "was"],
          correctIndex: 1
        },
      {
          question: "Adhesions are . . . . . . . formed within the body in response to inflammation or injury.",
      ...
      {
          question: "The planet Neptune is about 30 times . . . . . . from the Sun as Earth is.",
          options: ["far", "as far", "more far", "far that"],
          correctIndex: 1
        },
      {
          question: "Not until the 1850's . . . . . . a few public-spirited citizens and state legislatures seek to rescue historic buildings in the United States from destruction or alteration.",
          options: ["both", "came", "did", "when"],
          correctIndex: 2
        },
      {
          question: ". . . . . . 200 bones forming the framework, or skeleton, of the human body.",
          options: ["Being over", "There are over", "Where over", "Over"],
          correctIndex: 1
        },
      {
          question: "Andy Warhol was —— in the Pop Art movement who was known for his multi-image silk-screen paintings.",
          options: ["that one of a leading figure", "a leading figure", "leading figures", "who leads figures"],
          correctIndex: 1
        },
      {
          question: "Even with vast research, there is still a great deal that is —— known about the workings of the human brain.",
          options: ["neither", "none", "no", "not"],
          correctIndex: 3
        },
      {
          question: "—— the United States consists of many different immigrant groups, many sociologists believe there is a distinct national character.",
          options: ["In spite of", "Despite", "Even though", "Whether"],
          correctIndex: 2
        },
      {
          question: "Typically —— in meadows or damp woods and bloom in the spring.",
          options: ["wild violets grows", "wild violets growth", "growing wild violets", "the growth of wild violets"],
          correctIndex: 0
        },
      {
          question: "The art works of Madlyn-Ann Woolwich are characterized by strong, dark colors and fine attention to patterns of light —— the viewer’s eye.",
          options: ["that attract", "when attracted", "which attraction", "attract to"],
          correctIndex: 0
        },
      {
          question: "A grass-eating, river-dwelling mammal, the hippopotamus —— to the pig.",
          options: ["being related", "is related", "relate", "relating"],
          correctIndex: 1
        },
      {
          question: "Woodrow Wilson —— as governor of New Jersey before he was elected President of the United States in 1912.",
          options: ["to have served", "who has served", "serving", "served"],
          correctIndex: 3
        },
      {
          question: "—— fish in Great Salt Lake, but its waters do contain small brine shrimp.",
          options: ["Why no", "No", "Not only", "There are no"],
          correctIndex: 3
        },
      {
          question: "An etude is a short musical composition written especially —— a particular technique.",
      ...
      {
          question: "Seldom —— games been of practical use in playing real games.",
      ...
      {
          question: "Jet propulsion involves —— of air and fuel, which forms a powerful exhaust.",
          options: ["a mixture of ignited", "to ignite a mixture", "a mixture of igniting", "the ignition of a mixture"],
          correctIndex: 3
        },
      {
          question: "Salt is manufactured in quantities that exceed those of most ——– other commercial chemicals.",
          options: ["of all not", "not if all are", "are not all", "if not all"],
          correctIndex: 3
        },
      {
          question: "The United States consists of fifty states, ——- has its own government.",
          options: ["each of which", "each they", "they each", "each of"],
          correctIndex: 0
        },
      {
          question: "Though smaller than our solar system, a quasar, which looks like an ordinary star, emits more light —— galaxy.",
          options: ["than an entire", "entirely as", "that the entire", "entirely than"],
          correctIndex: 0
        },
      {
          question: "The upper branches of the tallest trees produce more leaves -------other branches.",
          options: ["than do", "than does", "than they do", "than it does"],
          correctIndex: 0
        },
      {
          question: "No one -----------projections of demographic shifts are reliable and will prove to be valid in the future.",
          options: ["know how", "knows whether", "knows even", "know who"],
          correctIndex: 1
        },
      {
          question: "Senior executives often receive bonuses when their profit targets are reached or---------",
          options: ["surpass", "surpasses", "surpassed", "surpassing"],
          correctIndex: 2
        },
      {
          question: "Since the 1970s, riding bicycles. . . . . . . . . in the United States.",
      ...
      {
          question: "Horseradish has extended stems and a large root that is grated . . . . . . . . . a spicy food sauce.",
          options: ["to making", "to make", "to be made", "to the making"],
          correctIndex: 1
        },
      {
          question: "Vitamin A maintains the sharpness of human vision . . . . . . . . . and promotes healthy bones.",
          options: ["at night", "of the night", "for the night", "nighttime"],
          correctIndex: 0
        },
      {
          question: ". . . . . . . . . , often used in children's poetry and rhymes, are a result of words used in ambiguous contexts.",
          options: ["Humorous and misunderstood", "Misunderstand humorously", "Humorous misunderstandings", "Misunderstanding its humor"],
          correctIndex: 2
        },
      {
          question: "Modern scanning technology enables physicians to identify brain disorder earlier . . . . . . . . . than in the past.",
          options: ["and more accurate", "and more accurately", "accurate and more", "accurately and more"],
          correctIndex: 1
        },
      {
          question: "Educational toys and games give children an opportunity to enjoy themselves--------------.",
          options: ["while their learning", "while learning", "are they learning", "and they are learning"],
          correctIndex: 1
        },
      {
          question: "William Hazlitt's essays, written in ----------- style, appeared between 1821 and 1822.",
          options: ["vigorously and informally", "vigorous and informally", "vigor and informality", "vigorous and informal"],
          correctIndex: 3
        },
      {
          question: "Wild hogs inhabited Europe and other parts of the world . . . . . . . . . 6 million years ago.",
          options: ["as long", "as long as", "then it was", "than it was"],
          correctIndex: 1
        },
      {
          question: "Electrically charged particles exert a magnetic force on one another even -------- not in physical contact.",
          options: ["if there are", "they are", "if they are", "are they"],
          correctIndex: 2
        },
      {
          question: "F. Scott Fitzgerald's early literary success led to extravagant living and ---------- a large income.",
          options: ["a need for", "to need for", "needed for", "for he needed"],
          correctIndex: 0
        },
      {
          question: "Water fire extinguishers must never be used for fires that involve---------",
          options: ["electrically equipped", "equipment, electrically", "electricity equipped", "electrical equipment"],
          correctIndex: 3
        },
      {
          question: "By the 1300s, the Spanish had learned that gunpowder could -------- propel an object with incredible force.",
          options: ["use to", "be used to", "been used to", "using it to"],
          correctIndex: 1
        },
      {
          question: "Fort Niagara was built by the French in 1726 on land …. the Seneca Indians.",
          options: ["They buy from", "bought from", "buying from", "was bought from"],
          correctIndex: 1
        },
      {
          question: "Soil texture depends on the proportions of clay and sand particles, ……soil porosity.",
      ...
      {
          question: "A ratio is a comparison of ……. whole or a part to another part.",
          options: ["part to the", "a part to", "a part to the", "the part to the"],
          correctIndex: 2
        },
      {
          question: "The bones of the elderly are more prone to fractures and splintering …. . of young people.",
          options: ["than that", "than those", "those than", "that than"],
          correctIndex: 1
        },
      {
          question: "English and Scottish settlers………. . Belfast as a trading post in 1613.",
          options: ["they established", "established themselves", "established", "establishing"],
          correctIndex: 2
        },
      {
          question: "The formulation of economic policies necessitates meticulous consideration…. . large segments of the population.",
          options: ["because they affect", "they are affected because", "affect them because", "because affecting them"],
          correctIndex: 0
        },
      {
          question: "Only…. . feathered creatures inhabit the Arctic region year around.",
          options: ["fewer", "fewer than", "as few as", "a few"],
          correctIndex: 3
        },
      {
          question: "Before Richard Bennet accepted the appointment as the prime minister of Canada in 1930, he…. . as a lawyer.",
          options: ["had achieved a successful", "had been achieved successfully", "has achieved success", "had achieved success"],
          correctIndex: 3
        },
      {
          question: "Gardeners transplant bushes and flowers by moving them from one place to …. .",
          options: ["other", "others", "another", "each other"],
          correctIndex: 2
        },
      {
          question: "Museums of natural history are ordinarily ……by special interest groups created for that purpose.",
          options: ["owned and operated", "they own and operate", "owning and operating", "the owner operates"],
          correctIndex: 0
        },
      {
          question: "A surge in the level of stress………. the recurrence of nightmares.",
          options: ["apparent increase", "apparently increase", "apparently increases", "apparent increase"],
          correctIndex: 2
        },
      {
          question: "Each bowler ………. . in each frame, unless a strike is bowled.",
          options: ["rolling the ball twice", "the ball is rolled twice", "rolls the ball twice", "the ball rolls twice"],
          correctIndex: 2
        },
      {
          question: "William Hearst had five sons,……………eventually became executives in the Hearts newspaper conglomerate.",
          options: ["all of them", "of them all", "all of whom", "who of all"],
          correctIndex: 2
        },
      {
          question: "An axiomatic assumption in physics holds that all matter has kinetic energy………. motion and mass.",
          options: ["because its", "because of its", "because it is", "because of it"],
          correctIndex: 1
        },
      {
          question: "The Eiffel Tower ___________ Paris, France.",
          options: ["landmarks", "is landmarked in", "is a landmark in", "is in a landmark"],
          correctIndex: 2
        },
      {
          question: "Young deer _________.",
          options: ["are called fawns", "be fawns", "is fawns", "are fawns called"],
          correctIndex: 0
        },
      {
          question: "Not until a dog is several months old does it begin to exhibit signs of independence ___________.",
          options: ["its mother from", "from mother", "to mother", "from its mother"],
          correctIndex: 3
        },
      {
          question: "To score a goal in soccer you ________.",
          options: ["must kick the ball", "must kicks the ball", "may kick them ball", "must kick them balls"],
          correctIndex: 0
        },
      {
          question: "The observation deck at the Sears Tower _________ in Chicago.",
      ...
      {
          question: "If it _________ so cloudy, we would plan on having the fair outside.",
      ...
      {
          question: "_______ chocolate will give you a tummy ache.",
          options: ["Eat too much", "Eating to much", "Eating too much", "Eating too many"],
          correctIndex: 2
        },
      {
          question: "If she ____________ to advance her clock one hour, she wouldn’t have been late for work.",
          options: ["should have remembered", "could remembered", "remembered", "would have remembered"],
          correctIndex: 3
        },
      {
          question: "A dream about falling _________.",
          options: ["scary is", "is scary", "are scary", "very scary is"],
          correctIndex: 1
        },
      {
          question: "George Washington _________first U. S. President.",
          options: ["was the", "became", "were the", "are the"],
          correctIndex: 0
        },
      {
          question: "Amelia Earhart was _______________ to pilot her plane across the Atlantic Ocean.",
          options: ["the first and a woman", "the first woman", "who the first woman", "the woman who first"],
          correctIndex: 1
        },
      {
          question: "____________ a tree can be grown from a seedling.",
          options: ["That is generally believed", "Believed generally is", "Generally believed it is", "It is generally believed that"],
          correctIndex: 3
        },
      {
          question: "The poverty level in the United State is currently set __________________.",
